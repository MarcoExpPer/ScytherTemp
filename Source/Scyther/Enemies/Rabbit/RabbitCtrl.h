...
public:
//Variables
	UPROPERTY( EditAnywhere, BlueprintReadWrite, Category = "Controller", meta = ( DisplayName = "rabbit pawn", ToolTip = "Pawn del conejo." ) )
	ARabbitPawn *rabbitPawn;
	
	UPROPERTY( VisibleAnywhere, BlueprintReadOnly, Category = "Blackboard Values", meta = ( DisplayName = "distance to detect player") )
		float distanceToDetectPlayer;

	UPROPERTY( VisibleAnywhere, BlueprintReadOnly, Category = "Blackboard Values", meta = ( DisplayName = "distance to attack player" ) )
